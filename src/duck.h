...
public:
    ...
    std::vector<glm::mat4> getTransforms() {
        ...
        glm::mat4 body_transform = glm::translate(glm::mat4(1.0), glm::vec3(CIRCLE_OFFSET,0.0,0.0)) * mainRotation() * glm::translate(glm::mat4(1.0), glm::vec3(0.0,0.0,CIRCLE_RADIUS));
