...
// MODIFIED: g_ContextMap as heap allocated pointer
// This resolves issues I was having with inconsistent state across library boundaries
struct ImGui_ImplGlfw_WindowToContext { GLFWwindow* Window; ImGuiContext* Context; };
static ImVector<ImGui_ImplGlfw_WindowToContext>* g_ContextMap = NULL;

static void ImGui_ImplGlfw_ContextMap_Add(GLFWwindow* window, ImGuiContext* ctx) {
    if(!g_ContextMap)
        g_ContextMap = new ImVector<ImGui_ImplGlfw_WindowToContext>();
